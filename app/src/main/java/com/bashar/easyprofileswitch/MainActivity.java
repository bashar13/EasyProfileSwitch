...
//                                    else {
//                                        //Toast.makeText(MainActivity.this, "Insert a name", Toast.LENGTH_LONG).show();
//                                        Intent edit_profile_act = new Intent(MainActivity.this, AddOrUpdateProfileActivity.class);
...
//                    Intent intet_update = new Intent(MainActivity.this, AddOrUpdateProfileActivity.class);
